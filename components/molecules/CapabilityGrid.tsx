...
export function CapabilityGrid({ capabilities }: CapabilityGridProps) {
  return (
    <ul className="mt-10 grid max-w-3xl grid-cols-1 gap-px overflow-hidden rounded-lg border border-white/10 bg-white/10 sm:grid-cols-3 lg:mt-14">
      {capabilities.map((capability) => (
        <li key={capability.label} className="bg-[#08090c]/90 p-5">
